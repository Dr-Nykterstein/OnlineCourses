      ...
      <div className="peoplePicker">
        ...
        <ul className="upper">
          <div className="stepper">
            <button
              className="button"
              onClick={(e) => this.DecreaseItem(e, "child")}
            >
              -
            </button>
            ...
            <button
              className="button"
              onClick={(e) => this.IncrementItem(e, "child")}
            >
              +
            </button>
          </div>
          <div className="stepper">
            <button
              className="button"
              onClick={(e) => this.DecreaseItem(e, "adult")}
            >
              -
            </button>
            ...
            <button
              className="button"
              onClick={(e) => this.IncrementItem(e, "adult")}
            >
              +
            </button>
          </div>
          <div className="stepper">
            <button
              className="button"
              onClick={(e) => this.DecreaseItem(e, "suit")}
            >
              -
            </button>
            ...
            <button
              className="button"
              onClick={(e) => this.IncrementItem(e, "suit")}
            >
              +
            </button>
          </div>
...
function convertDate(start) {
  if (
    RegExp(/^\d{4}-(0?[1-9]|1[012])-(0?[1-9]|[12][0-9]|3[01])$/).test(start)
  ) {
    return start;
  } else {
    if (start !== undefined) {
...
const SearchPanel = ({ functionCallFromParent }) => {
  const childFunction = (e) => {
    ...
    functionCallFromParent({ name, start, end, child, adult, suit });
  };
  return (
    <div className="searchPanelform">
      ...
      <div className="buttondiv">
        <button className="searchButton" onClick={childFunction}>
          Search
        </button>
      </div>
    </div>
